...
# Contributing to Sky Genesis Enterprise Project

Thank you for your interest in contributing to **Sky Genesis Enterprise**!  
...
**Sky Genesis Enterprise** is an open-source enterprise licensed under **AGPLv3**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/${project_name}$/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
```bash
git clone https://github.com/skygenesisenterprise/${project_name}.git
cd ${project_name}
````
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/${project_name}$/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve Sky Genesis Enterprise Project 💌
